...
<html>
    ...
    <body>
        ...
        <div class="container" style="min-height: calc(100vh - 183px); position: relative;">
                        ...
                        <td>
                            <div>
                                <h2 style="margin-bottom: 2.5rem">Grade report for <span id="ctl00_mainContent_lblRollNumber">${student.getName()}</span></h2>
                                                                    ...
                                                                    <table summary="Report">    
                                                                        ...
                                                                        <tfoot>
                                                                            <tr>
                                                                                ...
                                                                                <th colspan="3">
                                                                                    <fmt:setLocale value="en_US" />
                                                                                    <fmt:formatNumber value="${average}" pattern="#.#" var="scoreValue"/>
                                                                                    ${scoreValue}</th>
                                                                            </tr>
                                                                            <tr>
                                                                                <th>Status</th>
                                    ...
                                    <c:otherwise>Chưa có thông tin về các môn học</c:otherwise>
                                </c:choose>
        ...
        <table width="100%" style="border: 1px solid transparent; text-align: center;" id="cssTable">
            <tbody>
                <tr>
                    <td>
